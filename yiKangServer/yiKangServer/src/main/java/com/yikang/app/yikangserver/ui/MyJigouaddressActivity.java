...
public class MyJigouaddressActivity extends BaseActivity {
        ...
        tv_title_right_text.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(et_sex.getText().toString().equals("")){
                    Toast.makeText(getApplicationContext(),"请填写机构地址",Toast.LENGTH_SHORT).show();
                    return;
                }
                else{
                    showWaitingUI();
                    Api.alterAddr("北京","576767",et_sex.getText().toString(),alterNameHandler);
                }
            }
        });
    }
    ...
    private ResponseCallback<Void> alterNameHandler = new ResponseCallback<Void>() {
        ...
        public void onSuccess(Void data) {
            ...
            intent.putExtra("jigouaddress", et_sex.getText().toString());// mCurrentDistrictName
    ...
    protected void setContentView() {
        setContentView(R.layout.activity_my_jigouaddress);
    }
