...
public class MyHospitalAddressActivity extends BaseActivity {
        ...
        tv_title_right_text.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(et_address.getText().toString().equals("")){
                    ...
                    showWaitingUI();
                    Api.alterHospital(et_address.getText().toString(),alterNameHandler);
    ...
    private ResponseCallback<Void> alterNameHandler = new ResponseCallback<Void>() {
        ...
        public void onSuccess(Void data) {
            ...
            intent.putExtra("hospitaladdress", et_address.getText().toString());// mCurrentDistrictName
    ...
    protected void setContentView() {
        setContentView(R.layout.activity_my_hospital_address);
    }
