...
public class CertificateActivity extends BaseActivity {
    ...
    protected void findViews() {
        ...
        bt_choose_pictrue.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                CommonUtils.showCameraDialog(CertificateActivity.this,
    ...
    private ResponseCallback<FileResponse> activityPictrueHandler = new ResponseCallback<FileResponse>() {
        ...
        public void onSuccess(FileResponse data) {
           ...
           // LOG.i("debug", "[uploadAvatarHandler]上传图片成功" + picStr);
            hideWaitingUI();
            Api.alterUserCertificate(picStr,alterNameHandler);
    ...
    private ResponseCallback<Void> alterNameHandler = new ResponseCallback<Void>() {
        ...
        public void onSuccess(Void data) {
            ...
            Intent intent = new Intent();
            intent.putExtra("Certificate", "已上传");// mCurrentDistrictName
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == CommonUtils.PHOTO_REQUEST_CAMERA) {
            if (CommonUtils.hasSdcard()) {
                ...
                Toast.makeText(CertificateActivity.this, "未找到存储卡，无法存储照片！", Toast.LENGTH_SHORT)
                        .show();
            }
