...
public class MyJigouintroduceActivity extends BaseActivity {
        ...
        tv_title_right_text.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(et_sex.getText().toString().equals("")){
                    Toast.makeText(getApplicationContext(),"请填写机构简介",Toast.LENGTH_SHORT).show();
                    return;
                }
                else{
                    showWaitingUI();
    ...
    protected void setContentView() {
        setContentView(R.layout.activity_my_jigouintroduce);
    }
