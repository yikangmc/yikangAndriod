...
public class MyJigounameActivity extends BaseActivity {
        ...
        tv_title_right_text.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(et_sex.getText().toString().equals("")){
                    Toast.makeText(getApplicationContext(),"请填写机构名称",Toast.LENGTH_SHORT).show();
                    return;
                }
                else{
                    showWaitingUI();
                    Api.alterOraganizationName(et_sex.getText().toString(),alterNameHandler);
                }
            }
        });
    }
    private ResponseCallback<Void> alterNameHandler = new ResponseCallback<Void>() {
        ...
        public void onSuccess(Void data) {
            ...
            intent.putExtra("jigouname", et_sex.getText().toString());// mCurrentDistrictName
    ...
    protected void setContentView() {
        setContentView(R.layout.activity_my_jigouname);
    }
