...
public class DateTimePickerBirthday extends FrameLayout
{
    ...
    public DateTimePickerBirthday(Context context)
	{
    	super(context);
	...
	private void updateDateControl() 
    {
	  ...
	  {
	        void onDateTimeChanged(DateTimePickerBirthday view, int year, int month, int day, int hour, int minute);
	  }
