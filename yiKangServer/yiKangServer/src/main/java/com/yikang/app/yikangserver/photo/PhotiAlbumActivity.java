...
public class PhotiAlbumActivity extends Activity {
	...
	private void initView() {
		...
		adapter = new ImageBucketAdapter(PhotiAlbumActivity.this, dataList);
		...
		gridView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				Intent intent = new Intent(PhotiAlbumActivity.this,
						ImageGridActivity.class);
				intent.putExtra(ImageGridActivity.EXTRA_IMAGE_LIST,
