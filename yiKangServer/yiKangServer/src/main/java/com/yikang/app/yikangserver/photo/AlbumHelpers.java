...
public class AlbumHelpers {
	...
	private static AlbumHelpers instance;

	private AlbumHelpers() {
	}

	public static AlbumHelpers getHelper() {
		if (instance == null) {
			instance = new AlbumHelpers();
		}
		return instance;
	}
