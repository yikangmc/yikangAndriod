...
public final class CameraManager {
	...
	private static final int MIN_FRAME_WIDTH = ScreenModel.getPix(480);
	private static final int MIN_FRAME_HEIGHT = ScreenModel.getPix(480);

	private static final int MAX_FRAME_WIDTH = ScreenModel.getPix(507);
	private static final int MAX_FRAME_HEIGHT = ScreenModel.getPix(507);
