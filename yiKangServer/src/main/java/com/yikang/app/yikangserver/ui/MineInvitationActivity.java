 ...
 * 我的帖子界面
 */
public class MineInvitationActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void geneItems() {
        for (int i = 0; i < 10; i++) {
            ...
            lable.setHeadTvName("我的韧带撕裂，如何康复？" + i + "");
    ...
    protected void findViews() {
        ...
        mMessageAdapter = new CommonAdapter<LableDetailsBean>(this, lables, R.layout.list_lable_mine_item) {
            @Override
